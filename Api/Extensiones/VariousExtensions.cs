...
/// <summary>
/// Collection of various extensions
/// That were already defined in LINQPad
/// </summary>
namespace APIMocker.Extensiones
{
    #region MyExtensions
    ...
    public static class MyExtensions
    {
        ...
        /// Renamed 'Call' to 'Effect'
        /// </summary>
        public static T Effect<T>(this T obj, Action<T> act) { act.Invoke(obj); return obj; }
    ...
    public static class Tasker
    {
        ...
        public class CreatorArgs
        {
            ...
            public CreatorArgs(string id, string name, IEnumerable<string> description, string programmability, Meta metaobj)
            {
                ID = id;
                Name = name;
        ...
        public static CreatorArgs MakeCreator(string ID, string Name, string Programmability, string Leader)
        {
        ...
        public static void Create(string ID, string Name, string Programmability = "1", string Leader = "Tebi")
        {
            Create(MakeCreator(ID, Name, Programmability, Leader));
        }
        ...
        public static void Create(CreatorArgs creator)
        {
            ...
            {
                //"Directory already exists!".Dump(); Dump
            }
            else
            {
                //Task folder
                ...
                var programmabilityTxtName = string.Concat(directoryName, "/", "programmability.txt");
                ...
                //Programmability txt
                MyUtils.WriteTxt(creator.Programmability.AsArray(), programmabilityTxtName);
